  ...
  return (
    <>
      ...
      <div ref={heroRef} className="pt-32 pb-16 bg-cream px-6 lg:px-12 max-w-[1440px] mx-auto">
        ...
        <h1 className="projects-hero-text font-serif text-[clamp(2.2rem,6vw,7rem)] font-300 leading-[0.92] tracking-tight text-dark mt-6 mb-8 max-w-5xl">
          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex-shrink-0 w-full md:w-auto">
              <select
                ...
                className="w-full md:w-auto font-sans text-sm text-stone-500 bg-transparent border border-stone-200 rounded-full px-4 py-2 focus:outline-none focus:border-gold cursor-pointer hover:border-stone-400 transition-colors"
              >
