...
export default function AboutPage() {
  ...
  return (
    <>
      ...
      {/* Full-width image */}
      {/* TODO: Replace with real studio/team photo */}
      <div className="h-[50vh] lg:h-[60vh] bg-gradient-to-br from-stone-300 via-stone-400 to-stone-500 relative overflow-hidden img-placeholder">
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
            ...
            <AnimatedSection delay={0.2}>
              ...
              <div className="h-80 rounded-2xl bg-gradient-to-br from-stone-300 to-stone-400 relative overflow-hidden img-placeholder mt-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {awardsAndCerts.map((item, i) => (
              <AnimatedSection key={i} delay={i * 0.08}>
                <div className="bg-cream border border-stone-200 rounded-2xl p-6 hover:border-gold/40 hover:shadow-md transition-all duration-300">
