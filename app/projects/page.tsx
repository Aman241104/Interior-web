        ...
        <div ref={gridRef} className="max-w-[1440px] mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filtered.map((project) => (
              <div
                key={project.id}
                className="project-grid-card group rounded-2xl overflow-hidden border border-stone-200 hover:border-gold/40 hover:shadow-xl transition-all duration-400 bg-cream cursor-pointer"
              >
                {/* Image */}
                {/* TODO: Replace with real project photos */}
                <div className={`relative h-56 ${project.bgClass} img-placeholder overflow-hidden`}>
