          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-20 items-start">
            ...
            <div className="lg:col-span-2 space-y-10">
              ...
              <AnimatedSection delay={0.2}>
                <div className="h-64 rounded-2xl bg-gradient-to-br from-stone-200 to-stone-300 relative overflow-hidden img-placeholder">
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-2">
                    ...
                    <p className="font-sans text-sm text-stone-400 text-center px-4">
                      Paldi, Ahmedabad
                      <br />
                      <span className="text-xs">Near Fathepura Cross Road</span>
                    </p>
                  </div>
                </div>
              </AnimatedSection>
